...
var __ = function(
    ...
    trelloApiCommand.makeTrelloApiCall = function(options, onComplete) {
        ...
        var boardId, listId;
        if (options.alias) {
            listId = translator.getListIdByAlias(options.alias);
        } else {
            ...
            try {
                listId = options.alias ? translator.getListIdByAlias(options.alias) :
                    translator.getListIdByBoardNameAndListName(
                        options.boardName,
                        options.listName
                    );
            } catch (err) {
        ...
        program
            ...
            .options({
                ...
                alias: {
                    abbr: "a",
                    metavar: "ALIAS",
                    help: "Pre-configured alias of the list. Must supply either this option OR boardName, listName",
                    required: false
                },
                cardPosition: {
                    abbr: "q",
